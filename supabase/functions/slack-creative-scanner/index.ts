    ...
    if (requests.length > 0) {
      ...
      if (newRequests.length > 0) {
        ...
        for (const r of newRequests) {
          const initialFields = [
            { column_id: "Col09RPSC7FTN", rich_text: richText(r.description || "") },
            { column_id: "Col07QP76TBQD", rich_text: richText(r.platform || "Not specified") },
            { column_id: "Col09RL9S2DNW", rich_text: richText(r.format || "Not specified") },
          ];
